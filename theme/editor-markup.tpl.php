...
<i class="medium-small">When checked, this will name subsequent pages <b>when using the keyboard ↑ ↓ keys AND the current page name is alpha+numeric</b> pattern for example "i01" or "001toc".</i><br class="clearfloat" />
